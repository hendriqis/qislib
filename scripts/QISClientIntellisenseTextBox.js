function QISClientIntellisenseTextBoxHelper() {
    ...
    this.init = function (clientID, intellisenseHints) {
        ...
        var width = $('#' + _self.clientID + '_divIntellisense').find('table').first().width() - 25;
...
function QISClientIntellisenseTextBox() {
    ...
    this.IsFocus = function () {
        return $('#' + _self.clientID + '_divIntellisense .txtIntellisense').is(":focus");
    }
