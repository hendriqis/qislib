...
// look up screen for Trans (Item) All
function showDialogItemAll(ctrl)
{
	_sd(urlbItemAll, ctrl);
}

// look up screen for MutationNo
function showDialogMutation(ctrl)
{
	_sd(urlbMutation, ctrl);
}

// look up screen for Trans (Item)
function showDialogTrans(ctrl)
{
	_sd(urlbTrans, ctrl);
}

// look up screen for InvoiceNo
function showDialogARReceive(ctrl)
{
	_sd(urlbARReceive, ctrl);
}

// look up screen for InvoiceNo
function showDialogSalesTransactionInvoice(ctrl)
{
	_sd(urlbSalesTransactionInvoice, ctrl);
}
...
// look up screen for Customer Belum Proses Invoice
function showDialogSalesCustomerNotInvoice(ctrl)
{
	_sd(urlbSalesCustomerNotInvoice, ctrl);
}

// look up screen for Customer Sudah Proses Invoice Belum Terima Pembayaran
function showDialogSalesCustomerInvoiceNotPaid(ctrl)
{
	_sd(urlbSalesCustomerInvoiceNotPaid, ctrl);
}
