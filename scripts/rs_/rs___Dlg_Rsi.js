...
// look up screen for Master Tarif Pelayanan RI 
function ShowDialogTarifPelayananRI(ctrl)
{
	_sd(urlbTarifPelayananRI,ctrl);
}

function ShowDialogTarifPelayananRD(ctrl)
{
	_sd(urlbTarifPelayananRD,ctrl);
}
...
function ShowDialogTarifPelayananMD(ctrl)
{
	_sd(urlbTarifPelayananMD,ctrl);
}
...
//look up screen for kode jasa all
function ShowDialogKodeJasaAll(ctrl)
{
	_sd(urlbJasaMedisAll, ctrl)
}

function ShowDialogTransaksiRI(ctrl,nr)
{
	_sd(urlbtransaksiri+'?nr='+nr,ctrl);
}

function ShowDialogTransaksiMDRI(ctrl,nr)
{
	_sd(urlbtransaksimdri+'?nr='+nr,ctrl);
}

function ShowDialogTransaksiLBRI(ctrl,nr)
{
	_sd(urlbtransaksilbri+'?nr='+nr,ctrl);
}

function ShowDialogTransaksiRJ(ctrl,nr)
{
	_sd(urlbtransaksirj+'?nr='+nr,ctrl);
}

function ShowDialogTransaksiMDRJ(ctrl,nr)
{
	_sd(urlbtransaksimdrj+'?nr='+nr,ctrl);
}

function ShowDialogTransaksiLBRJ(ctrl,nr)
{
	_sd(urlbtransaksilbrj+'?nr='+nr,ctrl);
}


function ShowDialogTarifPelayananRiAktif(ctrl)
{
	_sd(urlbtarifpelayananriaktif, ctrl)
}

function ShowDialogTarifPelayananRjAktif(ctrl)
{
	_sd(urlbtarifpelayananrjaktif, ctrl)
}

function ShowDialogTarifPelayananRdAktif(ctrl)
{
	_sd(urlbtarifpelayananrdaktif, ctrl)
}

function ShowDialogTarifPelayananMdAktif(ctrl)
{
	_sd(urlbtarifpelayananmdaktif, ctrl)
}

function ShowDialogTarifPelayananLbAktif(ctrl)
{
	_sd(urlbtarifpelayananlbaktif, ctrl)
}
