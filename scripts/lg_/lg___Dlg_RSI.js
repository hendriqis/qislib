...
// look up screen for No Permintaan Service yang masih pending
function ShowDialogNoBuktiPending(ctrl)
{
	_sd(urlbNoBuktiPending, ctrl);
}
...
function ShowDialogService(ctrl)
{
	_sd(urlbService, ctrl);
}
