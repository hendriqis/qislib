...
function ShowDialogRencanaByNoReg(ctrl,kdp)
{
	_sd(urlbRencanaByNoReg +'?kdp='+kdp, ctrl)
}
...
// look up screen Transaksi Rencana Tindakan
function ShowDialogRencanaTindakan(ctrl,kdp)
{
	_sd(urlbRencTindakan +'?kdp='+kdp, ctrl)
}
...
// look up screen Transaksi
function ShowDialogTransaksiRD(ctrl)
{
	_sd(urlbTransaksiRD, ctrl)
}
...
// look up screen for RegistrasiRD
