...
function numToDollars4( n )
{
	return _numToUnits( n, '', 4, '' ) //' RP' )
}
...
function FormatCurrency4( txt )
{
	txt.value = numToDollars4(strToFloat(txt.value));
}

function FormatPercentase( txt )
{
	txt.value = numToPercent(strToFloat(txt.value));
}