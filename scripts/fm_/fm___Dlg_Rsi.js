...
// look up screen for Retur Resep RD
function ShowDialogReturResepRD(ctrl)
{
	_sd(urlbreturrsprd, ctrl);
}

// look up screen for Resep RD By NoReg
function ShowDialogResepRDByNoReg(ctrl,noreg)
{
	_sd(urlbreseprdbynoreg+'?noreg='+noreg,ctrl);
}

// look up screen for Resep RD
...
function ShowDialogBayarResepBebas(ctrl)
{
	_sd(urlresepbebas, ctrl);
}

function ShowDialogBayarObatBebas(ctrl)
{
	_sd(urlobatbebas, ctrl);
}

function ShowDialogBayarResepTakaful(ctrl)
{
	_sd(urlreseptakaful, ctrl);
}

function ShowDialogBayarResepRInap(ctrl)
{
	_sd(urlreseprinap, ctrl);
}

// look up screen for Ubah Penerimaan
...
function ShowDialogKwitansi(ctrl)
{
	_sd(urlkwitansi, ctrl);
}

function ShowDialogItemAllTakaful(ctrl,ins)
{
	_sd(urlitemalltakaful+'?ins='+ins,ctrl);
}

// look up screen for NIP
function ShowDialogNIP(ctrl)
{
	_sd(urlnip,ctrl);
}

// look up screen for Retur Kirim Barang
function ShowDialogReturKirimBarang(ctrl)
{
	_sd(urlbreturkb,ctrl);
}

// look up screen for Pengiriman Posted
function ShowDialogPengirimanPosted(ctrl,pnr)
{
	_sd(urlbkbposted+'?pnr='+pnr,ctrl);
}
