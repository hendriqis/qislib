...
// look up screen for Resep Rawat Darurat
function ShowDialogResepRdByNobukti(ctrl,nobukti)
{
	_sd(urlbreseprdByNobukti+'?nobukti='+nobukti, ctrl);
}


// look up screen for Resep
function ShowDialogResepRJ(ctrl,nobukti)
{
	_sd(urlbreseprj+'?nobukti='+nobukti, ctrl);
}
...
{
	_sd(urlbnoreturbysupforcn+'?kds='+sid,ctrl);
}
...
// look up screen for Nomor Bukti farmasi di resep RI
function ShowDialogResepFM(ctrl,nr)
{
	_sd(urlbreseprifm+'?nr='+nr,ctrl);
}

function ShowDialogResepFM_All(ctrl,nr)
{
	_sd(urlbreseprifmall+'?nr='+nr,ctrl);
}
...
// look up screen for Registrasi Rawat Inap
...
// look up screen for Resep Bebas Un Post
function ShowDialogRspBebasUnPost(ctrl)
{
	_sd(urlbresepbebasunpost, ctrl);
}

// look up screen for Resep Bebas Posting
function ShowDialogRspBebasPost(ctrl)
{
	_sd(urlbresepbebaspost, ctrl);
}
...
// look up screen for No. Resep RI All
function ShowDialogResepRInap(ctrl)
{
	_sd(urlbresepriall, ctrl);
}

// look up screen for No. Resep RI Berdasarkan tanggal
function ShowDialogResepRI_ByTanggal(ctrl, sttgl)
{
	_sd(urlbresepritgl+'?stgl='+sttgl,ctrl);
}

// look up screen for No. Resep RI Berdasarkan Resep
function ShowDialogResepRI_ByResep(ctrl, stresep)
{
	_sd(urlbreseprirsp+'?sresep='+stresep,ctrl);
}
...
// look up screen for No. Resep RI Berdasarkan noreg
function ShowDialogTherapiDetail(ctrl,kdl)
{
	_sd(urltherapidet+'?kdl='+kdl, ctrl);
}
...
// look up screen for Retur Resep Rawat Darurat
function ShowDialogReturRspRd(ctrl)
{
	_sd(urlbreturrsprd, ctrl);
}
...
// look up screen for Pembayaran Bebas
function ShowDialogBayarBebas(ctrl)
{
	_sd(urlbbayarbebas, ctrl);	
}

// look up screen for Noresep Pembayaran Bebas
function ShowDialogResepBayarBebas(ctrl)
{
	_sd(urlbresepbayarbebas, ctrl);	
}
...
// look up screen for Trans Id
function ShowDialogTransId(ctrl)
{
	_sd(urlbtransid, ctrl);	
}
...
// look up screen for registrasi rj
...
function ShowDialogMintaBarang(ctrl)
{
	_sd(urlbmintabarang, ctrl);
}
...
// look up screen for Resep Rawat Darurat
function ShowDialogResepRd(ctrl)
{
