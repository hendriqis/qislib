 ...
 *	 showInXYPos   | default: true; if true the calendar will be created in "XY EVENT" Position 		
...
Calendar.setup = function (params) {
	...
	param_default("showInXYPos",	true);
	...
	triggerEl["on" + params.eventName] = function(e) {
		...
		cal.refresh();
		if (params.showInXYPos) {
			if(!e)
				e = window.event;
			var posY = e.clientY;
			var posX = e.clientX; 
			cal.showAt(posX, posY);			
		} else {
